...
const blocks = [
  ...
  },
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 32 32" className="h-12 w-12">
...
export default function BlocksPage() {
  return (
        ...
        <div className="container mx-auto grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 py-12">
          {blocks.map((block) => (
            <Link
              key={block.id}
