...
By following these requirements, the CLI will be able to install ui components, templates, libs and hooks to the correct paths and handle imports for you.
