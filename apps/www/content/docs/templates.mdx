---
title: Add a block
description: Contribute components to the templates library.
---

We are inviting the community to contribute to the [templates library](/templates). Share your components and templates with other developers and help build a library of high-quality, reusable components.

We'd love to see all types of templates: applications, marketing, products, and more.
...
Create a new folder in the `apps/www/registry/new-york/templates` directory. Make sure the folder is named in kebab-case and under `new-york`.
...
### Add your block definition to `registry-templates.tsx`

To add your block to the registry, you need to add your block definition to `registry-templates.ts`.
...
```tsx title="apps/www/registry/registry-templates.tsx"
export const templates = [
  // ...
  {
    ...
    files: [
      ...
      {
        path: "templates/dashboard-01/components/hello-world.tsx",
        type: "registry:component",
      },
      {
        path: "templates/dashboard-01/components/example-card.tsx",
        type: "registry:component",
      },
      {
        path: "templates/dashboard-01/hooks/use-hello-world.ts",
        type: "registry:hook",
      },
      {
        path: "templates/dashboard-01/lib/format-date.ts",
        type: "registry:lib",
      },
    ],
...
Once the build script is finished, you can view your block at `http://localhost:3333/templates/[CATEGORY]` or a full screen preview at `http://localhost:3333/view/styles/new-york/dashboard-01`.
...
Here are some guidelines to follow when contributing to the templates library.
