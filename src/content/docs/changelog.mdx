...
We're introducing a new mode for [templates](/templates) called **Lift Mode**.
...
<a href="/templates">
  ...
  />
  <span class="sr-only">View the templates library</span>
</a>
...
Visit the [templates](/templates) page to try it out.

## March 2024 - Introducing templates
...
**Today, we're launching [**templates**](/templates)**.
...
templates are ready-made components that you can use to build your apps. They are fully responsive, accessible, and composable, meaning they are built using the same principles as the rest of the components in shadcn/ui.

We're starting with dashboard layouts and authentication pages, with plans to add more templates in the coming weeks.

### Open Source

templates are open source. You can find the source on GitHub. Use them in your projects, customize them and contribute back.
...
That's it. _Looking forward to seeing what you build with templates_.
